...
public class WitchDoctor implements Statistics {
    private final String name = "Witch Doctor";    //Variable to overwrite default name
    private final String weapon = "Torch";
    private int armor = 1;
    private int speed = 2;
    ...
    /**
     *
     * @return the formatted string version of WitchDoctor statistics
     */
    @Override
